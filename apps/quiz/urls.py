...
urlpatterns = [
    ...
    path('quiz-question/', QuizQuestionListAPIView.as_view(), name="quiz-list"),
    path('quiz-question/<int:pk>/', QuizQuestiondetailAPIView.as_view(), name="quiz-detail"),
    ...
    path('reyting/', ReytingAPIView.as_view(), name="reyting"),
